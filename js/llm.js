...
Sophrosyne.LLM = (function () {
  ...
  const DEFAULT_PROMPTS = {
    ...
    settle: [
      "请把【今日真实事务】折算为皇帝这一年（可分配到正月…腊月）的具体政务，并做如下三件事：",
      ...
      "只输出如下 JSON（无其他文字）：",
      '{"entries":[{"month":"正月","title":"帝御门听政，批阅奏章","effects":{"treasury":1000,"order":2},"note":"一句史官评语","classical":"古体起居录","modern":"白话翻译"}],"goalTitles":[{"goalId":"…","title":"古风国策名"}],"goalVerdicts":[{"goalId":"…","verdict":"评述"}],"subGoalVerdicts":[{"subGoalId":"…","verdict":"评述"}]}',
    ].join("\n"),
  ...
  return { settle, proposeSettlement, sanitizeDraft, posthumous, accession, ask, chat, context, buildSettlePrompt, extractJson, prompt, truncate, DEFAULT_PROMPTS, config, metricLegend };
})();
