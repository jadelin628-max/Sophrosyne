...
Sophrosyne.Scenes = (function () {
  const SCENES = [
    // —— 前朝 · 政务（学习 / 工作）——
    { id: "audience",   domain: "前朝", loc: "taihedian",  name: "御门听政", gov: "御门听政、面奏章疏", appointment: "沐浴更衣·备朝", defaultEffects: { prestige: 2, order: 1, corruption: -1 }, attrs: ["intellect", "prestige"], primary: "intellect" },
    ...
    { id: "exam",       domain: "前朝", loc: "taihedian",  name: "主持科举", gov: "主持乡试会试、取士", appointment: "张榜布告", defaultEffects: { xiuCai: 20, juRen: 5, jinShi: 2, corruption: -1 }, attrs: ["intellect", "prestige"], primary: "intellect" },
    ...
    { id: "lecture",    domain: "前朝", loc: "wenyuange", name: "经筵讲学", gov: "御前讲学、研讨经义", appointment: "备经备卷", defaultEffects: { xiuCai: 15, tech: 1 }, attrs: ["intellect"], primary: "intellect" },
    ...
    { id: "meditate",   domain: "内廷", loc: "yangxindian", name: "斋戒静思", gov: "静坐、正念、冥想", appointment: "焚香静心", defaultEffects: { support: 1 }, attrs: ["composure", "energy"], primary: "composure" },
    ...
    { id: "music",      domain: "内廷", loc: "yuhuayuan",  name: "宫廷雅乐", gov: "操琴、度曲、雅乐", appointment: "调弦正音", defaultEffects: { support: 1 }, attrs: ["talent", "composure"], primary: "talent" },
    ...
    { id: "finance",    domain: "内廷", loc: "yangxindian", name: "打理内帑", gov: "理账、家务、收纳", appointment: "清点账册", defaultEffects: { treasury: 200 }, attrs: ["energy"], primary: "energy" },
    { id: "banquet",    domain: "内廷", loc: "yuhuayuan",  name: "宴请群臣", gov: "宴饮、会友、社交", appointment: "备宴设席", defaultEffects: { support: 2, prestige: 1, treasury: -200 }, attrs: ["charm", "composure", "prestige"], primary: "charm" },
    { id: "love",       domain: "内廷", loc: "yuhuayuan",  name: "琴瑟和鸣", gov: "陪伴、约会、经营感情", appointment: "更衣理容", defaultEffects: { support: 2 }, attrs: ["charm", "composure"], primary: "charm" },
    { id: "diet",       domain: "内廷", loc: "yuhuayuan",  name: "药膳调理", gov: "饮食、药膳、养生", appointment: "传膳备药", defaultEffects: { population: 200, support: 1 }, attrs: ["health", "energy"], primary: "health" },
